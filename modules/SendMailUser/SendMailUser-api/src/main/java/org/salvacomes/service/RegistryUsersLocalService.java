...
/**
 * Provides the local service interface for RegistryUsers. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see RegistryUsersLocalServiceUtil
 * @generated
 */
@ProviderType
@Transactional(
...
public interface RegistryUsersLocalService
	extends BaseLocalService, PersistedModelLocalService {

	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link RegistryUsersLocalServiceUtil} to access the registry users local service. Add custom service methods to <code>org.salvacomes.service.impl.RegistryUsersLocalServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
